...
impl PluginRegistry {
    ...
    /// Calculates plugin load order based on dependencies
...
impl PluginManager {
    ...
    /// Gets all UI components from plugins
    ...
    /// Gets all menu items from plugins
